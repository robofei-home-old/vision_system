...
facerec = dlib.face_recognition_model_v1('/home/sousa/Documents/catkin_hera/src/vision_system/hera_face/src/lib/dlib_face_recognition_resnet_model_v1.dat')

win = dlib.image_window()

# Now process all the images
for f in glob.glob(os.path.join("/home/sousa/Documents/catkin_hera/src/vision_system/hera_face/face_images/*.jpg")):
    ...
    for k, d in enumerate(dets):
        ...
        print("is the same or no", face_descriptor)
